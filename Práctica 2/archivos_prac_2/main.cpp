...
//-----------------------------------------------------------------------
//variable que controla el modo de visualizacion

int
  modo_vis=1,	//modo de visualización
  modo_dib=2;	//modo de dibujado(con glBegin/glEnd o glDrawObjects)

//----------------------------------------------------------------------
//variable que controla la práctica activa

int practica_activa=1;
...
void DibujarObjetos()
{
  switch(practica_activa){
    case 1:
      P1_DibujarObjetos(modo_vis,modo_dib) ; // definido en 'practica1.hpp'
      break;
    case 2:
      P2_DibujarObjetos(modo_vis,modo_dib) ; // 'practica2.hpp'
      break;
    default:
      P1_DibujarObjetos(modo_vis,modo_dib) ;
      break;
  }
}
