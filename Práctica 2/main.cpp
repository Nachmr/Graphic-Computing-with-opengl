...
int 
   ...
   modo           ,  // Variable que determina el tipo de dibujado
   selprac		  ;  // Variable para seleccionar la práctica a ejecutar
   ...
   switch(selprac){
	   ...
	   case 2:
	     P2_DibujarObjetos(modo); // definido en 'practica2.hpp'
		  break;
	   default:
		  P2_DibujarObjetos(modo); // definido en 'practica1.hpp'
		  break;
   }
}
...
void FGE_PulsarTeclaNormal( unsigned char tecla, int x_raton, int y_raton )
{
   ...
   switch (toupper(tecla))
   {
      ...
      case '4': // Dibujado ajedrez
         modo=4;
         break;
      case '5': // Dibujado normales colores
         modo=5;
         break;
      case '6': // Dibujado normales lineas
         modo=6;
         break;
      default:
         redisp = false ;
...
void Inicializa_OpenGL( )
{
   ...
   frustum_factor_escala   = 0.108156 ;
